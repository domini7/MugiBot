...
module.exports = {
	...
	async execute(client, message, args, Discord, cmd) {
		...
		const statNames = [
			...
			{ stat: "reb", name: "Rebounds" },
			{ stat: "ast", name: "Assist" },
			{ stat: "tov", name: "Turnovers" },
			{ stat: "stl", name: "Steals" },
			{ stat: "blk", name: "Blocks" },
			{ stat: "pf", name: "Personal Fouls" },
			{ stat: "pts", name: "Points" },
			{ stat: "+/-", name: "Plus/Minus" },
